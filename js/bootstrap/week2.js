const quizData = [
    {
        question: "Q1 - Which of the following is not a Bootstrap color utility class?",
        a: 'bg-primary',
        b: 'bg-transparent',
        c: 'bg-success',
        d: 'bg-black',
    ...
    {
        question: "Q2 - Which of the following is not a Bootstrap spacing utility class?",
        a: "mt-5",
        b: "px-sm-3",
        c: "auto",
    ...
    {
        question: "Q8 - What is the HTML element we use for a larger input area in a form?",
        a: '<input-lg>',
        b: '<text>',
        c: '<textarea>',
        d: 'None of the above',
